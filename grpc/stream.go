...
func (a *csAttempt) shouldRetry(err error) (bool, error) {
	...
	if cs.numRetries+1 >= rp.MaxAttempts {
		fmt.Printf("zhf add code: error maxAttempts equals: %d, numRetries equals: %d\n", rp.MaxAttempts, cs.numRetries+1)
		return false, err
	} else {
		fmt.Printf("zhf add code: maxAttempts equals: %d, numRetries equals: %d\n", rp.MaxAttempts, cs.numRetries+1)
	}
